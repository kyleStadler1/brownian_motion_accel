...
HD_PWD='C:/Users/kcs-m/Documents/ieee/fastNormalLutProt/fastNormalLutProt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log normalRandGenTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source normalRandGenTop.tcl -notrace
