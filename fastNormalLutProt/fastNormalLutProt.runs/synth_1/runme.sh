...
HD_PWD='C:/Users/kcs-m/Documents/ieee/fastNormalLutProt/fastNormalLutProt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log normalRandGenTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source normalRandGenTop.tcl
