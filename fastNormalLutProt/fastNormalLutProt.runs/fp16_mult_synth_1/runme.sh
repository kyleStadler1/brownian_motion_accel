...
HD_PWD='C:/Users/kcs-m/Documents/ieee/fastNormalLutProt/fastNormalLutProt.runs/fp16_mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp16_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp16_mult.tcl
