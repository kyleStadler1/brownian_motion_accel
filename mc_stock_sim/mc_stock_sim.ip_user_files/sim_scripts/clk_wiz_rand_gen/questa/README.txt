...
#
# Generated by export_simulation on Tue Jan 06 01:33:03 -0800 2026
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_rand_gen.sh' script.

./clk_wiz_rand_gen.sh -reset_run
...
./clk_wiz_rand_gen.sh -noclean_files

For more information on the script, please type './clk_wiz_rand_gen.sh -help'.
