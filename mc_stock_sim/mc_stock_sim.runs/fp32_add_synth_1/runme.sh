...
HD_PWD='C:/Users/kcs-m/Documents/ieee/mc_stock_sim/mc_stock_sim.runs/fp32_add_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp32_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp32_add.tcl
