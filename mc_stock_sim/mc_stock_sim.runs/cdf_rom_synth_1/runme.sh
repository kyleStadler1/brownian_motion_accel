...
HD_PWD='C:/Users/kcs-m/Documents/ieee/mc_stock_sim/mc_stock_sim.runs/cdf_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cdf_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cdf_rom.tcl
