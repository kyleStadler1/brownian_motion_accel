...
HD_PWD='C:/Users/kcs-m/Documents/ieee/mc_stock_sim/mc_stock_sim.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log computation_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source computation_top.tcl
