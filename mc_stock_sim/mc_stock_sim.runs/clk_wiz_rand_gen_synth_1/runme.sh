...
HD_PWD='C:/Users/kcs-m/Documents/ieee/mc_stock_sim/mc_stock_sim.runs/clk_wiz_rand_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_rand_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_rand_gen.tcl
